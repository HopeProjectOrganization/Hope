    ...
    return ListView(
      ...
      children: [
        Column(
          ...
          children: [
            GestureDetector(
              onTap: () => showAvatarSheet(context, selectedAvatarAsset),
              child: Container(
            ...
            CustomButton(
              ...
              onClick: () async {
                try {
                  ...
                  showMessage(
                    context,
                    appLocalizations.accountUpdated,
                    posButtonTitle: appLocalizations.ok,
                    posButtonClick: () => Navigator.pop(context, true),
                  );
                } catch (e) {
                  showMessage(context, appLocalizations.updateError);
                }
              },
            ),
            const SizedBox(height: 20),
            CustomButton(
              ...
              onClick: () async {
                try {
                  ...
                  showMessage(context, appLocalizations.deleteError);
                }
              },
            ),
          ],
