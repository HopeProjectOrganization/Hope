...
import 'package:hope/Admin/aware/hereditary/hereditary_list.dart';
import 'package:hope/core/providers/theme_provider.dart';
import 'package:hope/core/theme/app_colors.dart';
import 'package:hope/ui/shared_widgets/custome_tab.dart';
import 'package:provider/provider.dart';

class AdminHereditary extends StatefulWidget {
  static const routeName = '/adminHereditary';

  const AdminHereditary({super.key});

  @override
  State<AdminHereditary> createState() => _HereditaryState();
}

class _HereditaryState extends State<AdminHereditary>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Hereditary", style: TextStyle(color: AppColors.white)),
        bottom: TabBar(
      ...
      body: TabBarView(
        controller: _tabController,
        children:
            cancerTypes.map((type) => AdminHereditaryList(type: type)).toList(),
      ),
