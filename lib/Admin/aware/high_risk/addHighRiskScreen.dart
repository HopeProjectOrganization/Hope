...
class AdminHighEditorScreen extends StatefulWidget {
  ...
  AdminHighEditorScreen({Key? key, this.newsData}) : super(key: key);

  @override
  State<AdminHighEditorScreen> createState() => _AdminNewsEditorScreenState();
}

class _AdminNewsEditorScreenState extends State<AdminHighEditorScreen> {
  ...
  void _submitNews() async {
    ...
    final url = isEdit
        ? 'http://192.168.78.153:8080/api/highrisk/$id'
        : 'http://192.168.78.153:8080/api/highrisk';
