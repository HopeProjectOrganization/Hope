                            ...
                            child: Column(
                                ...
                                children: [
                                  Row(children: [
                                    ...
                                    IconButton(
                                      icon: Icon(sel ? Icons.check : Icons.add,
                                          color: AppColors.purple, size: 25),
                                      onPressed: () {
                                        setState(() {
                                          selectedMeals[meal.id] = !sel;
                                  ...
                                  Row(mainAxisAlignment: MainAxisAlignment
                                    ...
                                    _buildNutritionIcon(
                                        ...
                                        meal.nutrients.calories.toStringAsFixed(
                                            1) + "kcal", AppIcons.calories),
                                    _buildNutritionIcon(
                                        appLocalizations.protein,
                                        meal.nutrients.protein.toStringAsFixed(
                                            1) + "g", AppIcons.proteins),
                                    _buildNutritionIcon(appLocalizations.fat,
                                        meal.nutrients.fat.toStringAsFixed(1) +
                                            "g", AppIcons.fats),
                                    _buildNutritionIcon(appLocalizations.carbs,
                                        meal.nutrients.netCarbs.toStringAsFixed(
                                            1) + "g", AppIcons.carbs),
                                  ]),
                                ]),
                          ),
